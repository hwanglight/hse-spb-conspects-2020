## Билет 05 "Стандартная библиотека C++, основы ввода-вывода"
...
Разница режимов в том, как обрабатывать специальные последовательности байт для определенных платформ. Под Linux бинарный и не бинарный режим работают одинаково. Под Windows, в текстовом режиме, \r\n при чтении переходит в \n и обратно при выводе.
